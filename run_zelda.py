...
def train(env_id, num_timesteps, seed, policy, lrschedule, num_env, save_path, wrapper_kwargs):
    ...
    model = learn(policy, env, seed, total_timesteps=int(num_timesteps * 1.1), lrschedule=lrschedule)
...
def main():
    ...
    train(args.env, num_timesteps=args.num_timesteps, seed=args.seed,
        policy=args.policy, lrschedule=args.lrschedule, num_env=16, save_path=args.save_path, wrapper_kwargs={'crop':args.crop, 'rotate':args.rotate})
